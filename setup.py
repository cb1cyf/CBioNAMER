...
setuptools.setup(
    name="CBioNAMER",                                     # 包的分发名称，使用字母、数字、_、-
    ...
    description="Nested Named Entity Recognition for Chinese Biomedical Text",                            # 包的简介描述
    ...
    url="https://github.com/cb1cyf/CBioNAMER/",                              # 项目开源地址，我这里写的是同性交友官网，大家可以写自己真实的开源网址
